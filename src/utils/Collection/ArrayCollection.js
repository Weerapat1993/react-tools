...
/**
 * Model Array Collection https://www.npmjs.com/package/array-collection
 * @param {Array} data
 * @param {stirng} primaryKey
 */
export const Model = (data, primaryKey) => new ArrayCollection(data, primaryKey) 
